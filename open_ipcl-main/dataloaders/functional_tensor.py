'''
    Copied from https://github.com/pytorch/vision/blob/main/torchvision/transforms/functional_tensor.py
    
    So that I can make a small tweak to enable transforms over images batches to work with 
...
def color_jitter_kornia(img: Tensor, hue_factor: float, saturation_factor: float, brightness_factor: float, contrast_factor: float) -> Tensor:
